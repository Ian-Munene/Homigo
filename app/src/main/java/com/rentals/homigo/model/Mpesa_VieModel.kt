...
class MpesaViewModel : ViewModel() {
    ...
    private val consumerKey = "qmcVny8HiACBdR1ZivN5vs0XasuA7mj2TMfolznaJt7Apzgj"
    private val consumerSecret = "RJHGGHIYnfdYdI3Qu311nilkZGkBFpWb6oTBTv9G4malEaQyte8EtKWpIYGghuxh"
    ...
    fun initiatePayment(phone: String, amount: String, onResult: (Boolean) -> Unit) {
        getAccessToken { token ->
            ...
            val json = JSONObject().apply {
                ...
                put("AccountReference", "Homigo")
                put("TransactionDesc", "Rent payment via Homigo")
            }
